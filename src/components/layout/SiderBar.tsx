...
export default function SideBar() {
  return (
    <div className="hidden max-h-screen flex-col items-end overflow-y-hidden md:py-4 lg:flex lg:w-[28%] lg:px-8 2xl:w-1/3">
      <div className="fixed flex h-full flex-col justify-start md:w-14 md:items-center md:gap-6 lg:w-64 lg:items-start lg:gap-4">
        ...
        <button className="lg:flex-center rounded-full bg-[#1D9BF0] font-bold text-mainPalette-text hover:bg-[#1daaff] md:p-4 lg:flex lg:h-fit lg:w-full lg:rounded-full lg:py-2 2xl:px-6">
